...
* Bump golang.org/x/net to v0.38 (via opencensus-exporter) for CVE-2025-22872 ([#506](https://github.com/launchdarkly/ld-relay/issues/506)) ([e1d7690](https://github.com/launchdarkly/ld-relay/commit/e1d769010ef0f9d6269e97666cf3d9d4fee0bcec))
* **deps:** bump supported Go versions to 1.24.4 and 1.23.10 ([#510](https://github.com/launchdarkly/ld-relay/issues/510)) ([5cd9e29](https://github.com/launchdarkly/ld-relay/commit/5cd9e292e5ff8ace96c4dd26d64ae8e7afab8ca0))

## [8.12.1](https://github.com/launchdarkly/ld-relay/compare/v8.12.0...v8.12.1) (2025-06-02)


### Bug Fixes

* Bump eventsource v1.9.1 ([f8837e0](https://github.com/launchdarkly/ld-relay/commit/f8837e017c97d9bb1b399caa1f271abeb805bdcd))
* Bump server SDK v7.10.2 ([f8837e0](https://github.com/launchdarkly/ld-relay/commit/f8837e017c97d9bb1b399caa1f271abeb805bdcd))
* **deps:** update Dockerfiles from 3.21.3 to alpine:3.22.0 ([#503](https://github.com/launchdarkly/ld-relay/issues/503)) ([ef7cc53](https://github.com/launchdarkly/ld-relay/commit/ef7cc539adf42c15bcc9d972196410088a7084b7))
...
* **deps:** bump supported Go versions to 1.24.2 and 1.23.8 ([#488](https://github.com/launchdarkly/ld-relay/issues/488)) ([779155b](https://github.com/launchdarkly/ld-relay/commit/779155bf4bbe28594b20e2cc56e9430716209309))
...
* **deps:** bump supported Go versions to 1.24.1 and 1.23.7 ([#481](https://github.com/launchdarkly/ld-relay/issues/481)) ([f437341](https://github.com/launchdarkly/ld-relay/commit/f437341cf36576adf97174bc73284dce856e6e63))

## [8.10.7](https://github.com/launchdarkly/ld-relay/compare/v8.10.6...v8.10.7) (2025-02-19)


### Bug Fixes

* **deps:** bump supported Go versions to 1.24.0 and 1.23.6 ([#477](https://github.com/launchdarkly/ld-relay/issues/477)) ([2e67f14](https://github.com/launchdarkly/ld-relay/commit/2e67f14012e05e416b7b6a46f2c14dbb6ebefa79))
* **deps:** update Dockerfiles from 3.21.2 to alpine:3.21.3 ([#478](https://github.com/launchdarkly/ld-relay/issues/478)) ([f945993](https://github.com/launchdarkly/ld-relay/commit/f9459939ea44a9230f22c9baac8d3e15ac3d7d70))
